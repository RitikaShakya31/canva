...
<body>
    <div class="container">
        ...
        <div class="mb-4 mt-3 flex items-center justify-between">
            <span style="font-weight: 500;font-size: 21px;">Accounting</span>
            <a href="brand.php">
                <button class="p-2 border rounded"
                    style="background: red;color: white; border-radius: 21px; padding: 8px 17px;">
                    <i class="fa fa-edit"></i>Change Category
                </button>
            </a>
        </div>
        <div id="section123-search-box" class="mb-4 flex items-center">
            <input type="text" placeholder="Select Category and Images.." class="p-2 border rounded flex-grow">
        </div>
        ...
        <div id="section123-vasant-panchami">
            <div class="header flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold other-h2">Auditor</h2>
        ...
        <div id="section123-vasant-panchami">
            <div class="header flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold other-h2">Accounting Firm</h2>
                <div class="flex-grow border-t border-gray-300 mx-4"></div>
                <a href="" class="text-black-500 hover:underline">See all <i class="fa fa-chevron-right"
                        aria-hidden="true"></i></a>
            </div>
        ...
        <div id="section123-vasant-panchami">
            <div class="header flex items-center justify-between mb-6">
                <h2 class="text-2xl font-bold other-h2">Chartant Accountant</h2>
                <div class="flex-grow border-t border-gray-300 mx-4"></div>
                <a href="" class="text-black-500 hover:underline">See all <i class="fa fa-chevron-right"
                        aria-hidden="true"></i></a>
            </div>
